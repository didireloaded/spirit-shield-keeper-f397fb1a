      ...
      if (isLogin) {
        ...
        if (error) {
          ...
          if (avatarFile) {
            ...
            if (newUser) await uploadAvatar(newUser.id);
          }
          setShowConsent(true);
        }
      }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex flex-col items-center pt-14 pb-6">
        ...
        >
          <div className="w-16 h-16 rounded-2xl gradient-guardian flex items-center justify-center shadow-guardian">
            <Shield className="w-9 h-9 text-primary-foreground" />
          </div>
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gradient-guardian font-display">Spirit Shield</h1>
        ...
        <div className="max-w-sm mx-auto">
          ...
          {error && (
            <motion.div
              ...
              className="mb-4 p-3 bg-destructive/10 border border-destructive/20 rounded-xl flex items-start gap-2"
            >
      ...
      <div className="p-6 text-center">
        <p className="text-xs text-muted-foreground">
          By continuing, you agree to Spirit Shield's{' '}
