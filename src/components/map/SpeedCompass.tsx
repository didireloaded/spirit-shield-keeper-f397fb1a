    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="fixed top-[calc(var(--map-top-row)+44px+var(--map-element-gap)+44px+var(--map-element-gap)+44px+var(--map-element-gap))] right-[var(--map-inset)] z-[var(--z-map-feedback)] bg-background/90 backdrop-blur-md rounded-2xl border border-border/50 shadow-lg p-2.5"
        >
